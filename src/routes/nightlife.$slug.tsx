...
export const Route = createFileRoute("/nightlife/$slug")({
  loader: async ({ params }) => {
  ...
  head: ({ loaderData }) => {
    ...
    if (!l) return { meta: [{ title: "Nightlife — sandiego.com" }] };
  ...
  notFoundComponent: () => (
    <div className="min-h-screen grid place-items-center px-4 text-center">
      <div>
        ...
        <a href="/nightlife" className="mt-4 inline-block text-accent">Back to nightlife</a>
      </div>
    </div>
  ),
  component: () => {
